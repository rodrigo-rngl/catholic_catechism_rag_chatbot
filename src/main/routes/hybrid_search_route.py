...
from src.validators.models.HttpRequest import HttpRequestIn, HttpRequestOut
...
logger = setup_logger(name="hybrid_search_route")

hybrid_search_route = APIRouter(tags=["Busca Híbrida"])


@hybrid_search_route.post("/hybrid_search",
                          ...
                          responses={
                              ...
                              406: {"description": "Not Acceptable Error (Clarification Solicitation)",
                                    "model": HttpResponse,
                                    "content": {"application/json":
                                                {"example":
                                                 {
                              ...
                              400: {"description": "Bad Request Error (Validation Error)",
                                    "model": HttpResponse,
                                    "content": {"application/json":
                                                {"example":
                                                   {
                              ...
                              422: {"description": "Unprocessable Entity Error (Domain Error)",
                                    "model": HttpResponse,
                                    "content": {"application/json":
                                                {"example":
                                                 {
...
async def hybrid_search(http_request: HttpRequestIn) -> JSONResponse:
    try:
        http_request = HttpRequestOut(**http_request.model_dump())
